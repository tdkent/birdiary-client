  ...
  return (
    <>
      <div className="flex pr-4 sm:gap-1 lg:gap-2">
        {sightings.slice(0, iconsToShow).map((sighting) => {
          ...
          return (
            <React.Fragment key={sightingId}>
              <div className="relative ml-[-20px] aspect-square w-14 overflow-hidden rounded-full bg-background shadow-md shadow-gray-800 dark:shadow-gray-900 sm:m-0 md:w-16">
                <Image
                  alt={commonName}
        ...
        {remainingCount >= 1 && (
          <>
            <div className="relative ml-[-20px] flex aspect-square w-14 items-center justify-center overflow-hidden rounded-full bg-gray-100 shadow-md shadow-gray-800 dark:bg-blue-950 dark:shadow-gray-900 sm:m-0 md:w-16">
